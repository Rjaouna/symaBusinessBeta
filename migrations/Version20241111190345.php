 ...
 */
final class Version20241111190345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carte_sim (id INT AUTO_INCREMENT NOT NULL, purchased_by_id INT DEFAULT NULL, type_id INT NOT NULL, user_id INT DEFAULT NULL, chapelet_id INT NOT NULL, serial_number VARCHAR(19) NOT NULL, reserved TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', etat VARCHAR(50) DEFAULT NULL, usage_finale VARCHAR(50) DEFAULT NULL, INDEX IDX_67D57BF451D43F65 (purchased_by_id), INDEX IDX_67D57BF4C54C8C93 (type_id), INDEX IDX_67D57BF4A76ED395 (user_id), INDEX IDX_67D57BF4DFE7E91 (chapelet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, type_sim_id INT NOT NULL, numero VARCHAR(10) NOT NULL, qte INT NOT NULL, qtevalidee INT DEFAULT NULL, total VARCHAR(50) NOT NULL, status VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', sim_type VARCHAR(50) NOT NULL, code_client VARCHAR(50) NOT NULL, modified TINYINT(1) DEFAULT NULL, qte_bonus_used VARCHAR(10) DEFAULT NULL, INDEX IDX_6EEAA67DA76ED395 (user_id), INDEX IDX_6EEAA67DDBCD9334 (type_sim_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lignes_commande (id INT AUTO_INCREMENT NOT NULL, cartes_sims_id INT DEFAULT NULL, commande_id INT NOT NULL, type_sim_id INT DEFAULT NULL, prix_unitaire VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', serial_number VARCHAR(14) NOT NULL, numero_commande VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_DAAE0FCB755D0B32 (cartes_sims_id), INDEX IDX_DAAE0FCB82EA2E54 (commande_id), INDEX IDX_DAAE0FCBDBCD9334 (type_sim_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE syma_business_config (id INT AUTO_INCREMENT NOT NULL, nom_du_responsable VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, numero_de_telephone VARCHAR(50) NOT NULL, numero_de_fixe VARCHAR(50) NOT NULL, raison_sociale VARCHAR(50) NOT NULL, numero_de_registre VARCHAR(50) NOT NULL, forme_juridique VARCHAR(50) NOT NULL, code_ape_naf VARCHAR(50) NOT NULL, capital_social VARCHAR(50) NOT NULL, numero_de_tva_intracommunautaire VARCHAR(50) NOT NULL, numero_siret VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
